...
public class FormularioEdad extends javax.swing.JFrame {
    ...
    public FormularioEdad() {
        ...
        javax.swing.JFrame.setDefaultLookAndFeelDecorated(true);//titulo de ventana
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jLabel2.setText("Vamos a validar tu dad"); 
        try {
           int edad=new Integer(jTextField1.getText());
           ValidarEdad.validar(edad);
            jLabel1.setText("Si tu te vez no se lanzo la excepcion");
        } catch(Exception ex){
            jLabel1.setText("No puedes meter letras tontoooo");
        }
